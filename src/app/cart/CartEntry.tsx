...
export default function CartEntry({cartItem: {product, quantity}}: CartEntryProps){
  ...
  return <div >
    ...
    <div>
      ...
      <div className="my-1 flex items-center gap-2">Quantity: <select className="select select-bordered w-full max-w-[80px]" defaultValue={quantity}
      onChange={e=>{
      ...
      {isPending && <span className="loading loading-spinner loading-sm"></span>}</div>
